...
//client.sendMessage(from, { react: { text: `🍉`, key: info.key }})
if(!isGroup){ 
const linka = "https://youtube.com/@clovermods"
const buttonMessage = {
...
║
╚════• 〘${nomeBot}〙•═════╝
👑 Canal do bot: https://whatsapp.com/channel/0029Va974hY2975B61INGX3Q

👑 Entre em contato: https://instagram.com/clovermods?igshid=MmcyMHlrYnhoN2Zk
`,
    footer: `🍉${nomeBot}🍉`,
  //  buttons: buttons,
    headerType: 4
